...
@Component({
  selector: 'app-yin',
  templateUrl: './yin.component.html',
  styleUrls: ['./yin.component.scss']
})
export class YinComponent implements OnInit {
  ...
  ngOnInit() {
    this._httpService.getYinApi().subscribe((data) => {
      this.faction = data;
      console.log('Yin Data')
